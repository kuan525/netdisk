...
// Signup 处理用户注册请求
func (u *User) Signup(ctx context.Context, req *accProto.ReqSignup, res *accProto.RespSignup) error {
...
// Signin 处理用户登陆请求
func (u *User) Signin(ctx context.Context, req *accProto.ReqSignin, res *accProto.RespSignin) error {
	username := req.Username
...
// UserInfo 查询用户信息
func (u *User) UserInfo(ctx context.Context, req *accProto.ReqUserInfo, res *accProto.RespUserInfo) error {
	// 查询用户信息
