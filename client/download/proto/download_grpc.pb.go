...
const (
	DownloadService_DownloadEntry_FullMethodName = "/go.micro.service.download.DownloadService/DownloadEntry"
)
...
func (c *downloadServiceClient) DownloadEntry(ctx context.Context, in *ReqEntry, opts ...grpc.CallOption) (*RespEntry, error) {
	out := new(RespEntry)
	err := c.cc.Invoke(ctx, DownloadService_DownloadEntry_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DownloadService_DownloadEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DownloadService_DownloadEntry_FullMethodName,
	}
