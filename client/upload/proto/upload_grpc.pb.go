...
const (
	UploadService_UploadEntry_FullMethodName = "/go.micro.service.upload.UploadService/UploadEntry"
)
...
func (c *uploadServiceClient) UploadEntry(ctx context.Context, in *ReqEntry, opts ...grpc.CallOption) (*RespEntry, error) {
	out := new(RespEntry)
	err := c.cc.Invoke(ctx, UploadService_UploadEntry_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _UploadService_UploadEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UploadService_UploadEntry_FullMethodName,
	}
